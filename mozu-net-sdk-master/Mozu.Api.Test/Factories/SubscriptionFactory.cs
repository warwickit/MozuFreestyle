...
namespace Mozu.Api.Test.Factories
{
	...
	public partial class SubscriptionFactory : BaseDataFactory
	{
		...
		/// <example> 
		///  <code> 
		/// var result = SubscriptionFactory.GetSubscriptions(handler : handler,  startIndex :  startIndex,  pageSize :  pageSize,  sortBy :  sortBy,  filter :  filter,  expectedCode: expectedCode, successCode: successCode); 
