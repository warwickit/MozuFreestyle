...
namespace Mozu.Api.Clients.Platform.SiteData
{
	/// <summary>
	...
	public partial class SiteDataClient 	{
		...
		{
			var url = Mozu.Api.Urls.Platform.SiteData.SiteDataUrl.GetDBValueUrl(dbEntryQuery);
...
;
		...
		{
			var url = Mozu.Api.Urls.Platform.SiteData.SiteDataUrl.CreateDBValueUrl(dbEntryQuery);
		...
		{
			var url = Mozu.Api.Urls.Platform.SiteData.SiteDataUrl.UpdateDBValueUrl(dbEntryQuery);
		...
		{
			var url = Mozu.Api.Urls.Platform.SiteData.SiteDataUrl.DeleteDBValueUrl(dbEntryQuery);
