...
namespace Mozu.Api.Test.Factories
{
	...
	/// </summary>
	public partial class ShippingSettingsFactory : BaseDataFactory
	{
		...
		/// <example> 
		///  <code> 
		/// var result = ShippingSettingsFactory.GetSiteShippingSettings(handler : handler,  responseFields :  responseFields,  expectedCode: expectedCode, successCode: successCode); 
		 ...
		 HttpStatusCode expectedCode = HttpStatusCode.OK, HttpStatusCode successCode = HttpStatusCode.OK)
		{
			...
			var apiClient = Mozu.Api.Clients.Commerce.Settings.ShippingSettingsClient.GetSiteShippingSettingsClient(
