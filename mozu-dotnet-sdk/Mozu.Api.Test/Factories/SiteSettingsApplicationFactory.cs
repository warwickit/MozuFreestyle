...
namespace Mozu.Api.Test.Factories
{
	...
	/// </summary>
	public partial class SiteSettingsApplicationFactory : BaseDataFactory
	{
		...
		/// <example> 
		///  <code> 
		/// var result = SiteSettingsApplicationFactory.ThirdPartyGetApplication(handler : handler,  responseFields :  responseFields,  expectedCode: expectedCode, successCode: successCode); 
		...
		/// <example> 
		///  <code> 
		/// var result = SiteSettingsApplicationFactory.ThirdPartyUpdateApplication(handler : handler,  application :  application,  responseFields :  responseFields,  expectedCode: expectedCode, successCode: successCode); 
		/// var optionalCasting = ConvertClass<Application/>(result); 
		/// return optionalCasting;
		///  </code> 
		/// </example> 
