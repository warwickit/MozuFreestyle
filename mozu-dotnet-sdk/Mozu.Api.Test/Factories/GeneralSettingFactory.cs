...
namespace Mozu.Api.Test.Factories
{
	...
	/// </summary>
	public partial class GeneralSettingFactory : BaseDataFactory
	{
		...
		/// <example> 
		///  <code> 
		/// var result = GeneralSettingFactory.GetGeneralSettings(handler : handler,  responseFields :  responseFields,  expectedCode: expectedCode, successCode: successCode); 
		...
		/// <example> 
		///  <code> 
		/// var result = GeneralSettingFactory.UpdateGeneralSettings(handler : handler,  generalSettings :  generalSettings,  responseFields :  responseFields,  expectedCode: expectedCode, successCode: successCode); 
		/// var optionalCasting = ConvertClass<GeneralSettings/>(result); 
		/// return optionalCasting;
		///  </code> 
		/// </example> 
