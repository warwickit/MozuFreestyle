...
namespace Mozu.Api.Test.Factories
{
	...
	/// </summary>
	public partial class ShippingSettingFactory : BaseDataFactory
	{
		...
		/// <example> 
		///  <code> 
		/// var result = ShippingSettingFactory.GetSiteShippingSettings(handler : handler,  responseFields :  responseFields,  expectedCode: expectedCode, successCode: successCode); 
