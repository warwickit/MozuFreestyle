...
namespace Mozu.Api.Test.Factories
{
	...
	/// </summary>
	public partial class ExtensionsFactory : BaseDataFactory
	{
		...
		/// <example> 
		///  <code> 
		/// var result = ExtensionsFactory.GetExtensions(handler : handler,  responseFields :  responseFields,  expectedCode: expectedCode, successCode: successCode); 
		 ...
		 HttpStatusCode expectedCode = HttpStatusCode.OK, HttpStatusCode successCode = HttpStatusCode.OK)
		{
			...
			var apiClient = Mozu.Api.Clients.Platform.ExtensionsClient.GetExtensionsClient(
		...
		/// <example> 
		///  <code> 
		/// var result = ExtensionsFactory.UpdateExtensions(handler : handler,  extensions :  extensions,  responseFields :  responseFields,  expectedCode: expectedCode, successCode: successCode); 
		/// var optionalCasting = ConvertClass<TenantExtensions/>(result); 
		/// return optionalCasting;
		///  </code> 
		/// </example> 
		 ...
		 HttpStatusCode expectedCode = HttpStatusCode.OK, HttpStatusCode successCode = HttpStatusCode.OK)
		{
			...
			var currentMethodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
			Debug.WriteLine(currentMethodName  + '.' + currentMethodName );
			var apiClient = Mozu.Api.Clients.Platform.ExtensionsClient.UpdateExtensionsClient(
