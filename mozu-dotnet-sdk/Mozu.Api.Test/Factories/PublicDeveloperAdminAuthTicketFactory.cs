...
namespace Mozu.Api.Test.Factories
{
	...
	/// </summary>
	public partial class PublicDeveloperAdminAuthTicketFactory : BaseDataFactory
	{
		...
		/// <example> 
		///  <code> 
		/// var result = PublicDeveloperAdminAuthTicketFactory.CreateDeveloperUserAuthTicket(handler : handler,  userAuthInfo :  userAuthInfo,  developerAccountId :  developerAccountId,  responseFields :  responseFields,  expectedCode: expectedCode, successCode: successCode); 
		...
		/// <example> 
		///  <code> 
		/// var result = PublicDeveloperAdminAuthTicketFactory.DeleteUserAuthTicket(handler : handler,  refreshToken :  refreshToken,  expectedCode: expectedCode, successCode: successCode); 
