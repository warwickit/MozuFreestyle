...
namespace Mozu.Api.Test.Factories
{
	...
	/// </summary>
	public partial class PublicCardsFactory : BaseDataFactory
	{
		...
		/// <example> 
		///  <code> 
		/// var result = PublicCardsFactory.Create(handler : handler,  request :  request,  expectedCode: expectedCode, successCode: successCode); 
		 ...
		 HttpStatusCode expectedCode = HttpStatusCode.Created, HttpStatusCode successCode = HttpStatusCode.Created)
		{
			...
			var apiClient = Mozu.Api.Clients.Commerce.Payments.PublicCardsClient.CreateClient(
				 request :  request		);
			try
			{
		...
		/// <example> 
		///  <code> 
		/// var result = PublicCardsFactory.Delete(handler : handler,  cardId :  cardId,  expectedCode: expectedCode, successCode: successCode); 
		 ...
		 HttpStatusCode expectedCode = HttpStatusCode.NoContent, HttpStatusCode successCode = HttpStatusCode.NoContent)
		{
			...
			var currentMethodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
			Debug.WriteLine(currentMethodName  + '.' + currentMethodName );
			var apiClient = Mozu.Api.Clients.Commerce.Payments.PublicCardsClient.DeleteClient(
				 cardId :  cardId		);
			try
			{
				apiClient.WithContext(handler.ApiContext).Execute();
