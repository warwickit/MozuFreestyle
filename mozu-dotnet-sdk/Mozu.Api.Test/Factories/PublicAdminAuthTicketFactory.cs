...
namespace Mozu.Api.Test.Factories
{
	...
	/// </summary>
	public partial class PublicAdminAuthTicketFactory : BaseDataFactory
	{
		...
		/// <example> 
		///  <code> 
		/// var result = PublicAdminAuthTicketFactory.CreateUserAuthTicket(handler : handler,  userAuthInfo :  userAuthInfo,  tenantId :  tenantId,  responseFields :  responseFields,  expectedCode: expectedCode, successCode: successCode); 
		...
		/// <example> 
		///  <code> 
		/// var result = PublicAdminAuthTicketFactory.RefreshAuthTicket(handler : handler,  existingAuthTicket :  existingAuthTicket,  tenantId :  tenantId,  responseFields :  responseFields,  expectedCode: expectedCode, successCode: successCode); 
		/// var optionalCasting = ConvertClass<TenantAdminUserAuthTicket/>(result); 
		/// return optionalCasting;
		///  </code> 
		/// </example> 
		...
		/// <example> 
		///  <code> 
		/// var result = PublicAdminAuthTicketFactory.DeleteUserAuthTicket(handler : handler,  refreshToken :  refreshToken,  expectedCode: expectedCode, successCode: successCode); 
